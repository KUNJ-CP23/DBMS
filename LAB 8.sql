...
SELECT SUM(SALES_AMOUNT) AS TOTAL_AMT
FROM SALES_DATA
GROUP BY REGION;
...
SELECT YEAR,REGION, MIN(SALES_AMOUNT) AS MIN_AMT
FROM SALES_DATA
GROUP BY YEAR,REGION;

--5. Count of Products Sold by Region
SELECT REGION, COUNT(SALES_AMOUNT) AS TOTAL
FROM SALES_DATA
GROUP BY REGION;
...
--12. Display Total Sales Amount by Region for Year 2023,Sorted by Total Amount (ASCENDING ORDER) 
SELECT REGION,SUM(SALES_AMOUNT) AS TOTAL
FROM SALES_DATA
WHERE YEAR=2023
GROUP BY REGION
...
SELECT REGION,YEAR,COUNT(SALES_AMOUNT) AS COUNT
FROM SALES_DATA
GROUP BY YEAR,REGION
...
SELECT YEAR,COUNT(PRODUCT) AS TOTAL
FROM SALES_DATA
GROUP BY YEAR
