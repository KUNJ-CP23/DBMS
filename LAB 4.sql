...
EXEC SP_RENAME 'DEPOSIT','DEPOSIT_DETIAL';

--Part – B: 

--1. Rename Column ADATE to AOPENDATE OF DEPOSIT_DETAIL table.
EXEC SP_RENAME 'DEPOSIT_DETIAL.ADATE','AOPENDATE';

--2. Delete Column AOPENDATE from the DEPOSIT_DETAIL table.
ALTER TABLE DEPOSIT_DETIAL DROP COLUMN AOPENDATE;

--3. Rename Column CNAME to CustomerName. 
EXEC SP_RENAME 'DEPOSIT_DETIAL.CNAME', 'CUSTOMERNAME';

SELECT * FROM DEPOSIT_DETIAL;
...
--1. Delete all the records of DEPOSIT_DETAIL table having amount 
--greater than and equals to 4000. 
DELETE FROM DEPOSIT_DETIAL WHERE AMOUNT>=4000;

--2. Delete all the accounts CHANDI BRANCH. 
DELETE FROM DEPOSIT_DETIAL WHERE BNAME='CHANDI';

--3. Delete all the accounts having account number (ANO) is greater than 105.
DELETE FROM DEPOSIT_DETIAL WHERE ANO>105;

--4. Delete all the records of Deposit_Detail table. (Use Truncate) 
TRUNCATE TABLE DEPOSIT_DETIAL;

--5. Remove Deposit_Detail table. (Use Drop) 
DROP TABLE DEPOSIT_DETIAL;
...
(106,'MITESH','2025-09-25',5000,'JAMNAGAR'),
...
--1. Delete all the records of Employee_MASTER table having salary 
--greater than and equals to 14000.  
...
DELETE FROM EMPLOYEE_MASTER WHERE SALARY= 0.5*10000;
