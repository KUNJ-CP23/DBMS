...
--2. Display all the details of first three depositors whose amount is greater 
--than 1000. 
SELECT TOP 3 * FROM DEPOSIT WHERE AMOUNT>1000; 

--3. Display Loan No, Customer Name of first five borrowers whose branch 
--name does not belongs to ‘ANDHERI’ from borrow table. 
